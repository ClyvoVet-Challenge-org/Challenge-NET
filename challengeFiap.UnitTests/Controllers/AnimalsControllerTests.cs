...
namespace challengeFiap.UnitTests.Controllers
{
    public class AnimalsControllerTests
    {
        ...
        [Fact]
        public async Task GetAll_Animal_RetornandoOk()
        {
            // Arrange
            ...
            _animalServiceMock.Setup(s => s.GetAllAnimalsAsync()).ReturnsAsync(list);

            // Act
            var resultado = await _controller.GetAllAnimal();

            // Assert
            var okResult = Assert.IsType<OkObjectResult>(resultado.Result);
            var returnedList = Assert.IsType<List<Animal>>(okResult.Value);
        ...
        public async Task GetId_Animal_RetornandoOk()
        {
            ...
            _animalServiceMock.Setup(s => s.GetAnimalAsync(id_animal))
                .ReturnsAsync(animal);
        ...
        public async Task Deleta_animal()
        {
            ...
            _animalServiceMock.Setup(s => s.DeleteAnimalAsync(id_animal)).ReturnsAsync(animal);
