...
{
    public class EnderecoAnimalControllerIntegrationTests
    {
        private readonly HttpClient _client;

        public EnderecoAnimalControllerIntegrationTests(ApiFactoryFixture factory)
        {
        ...
        public async Task GetEnderecoAnimal_Dados_RetornaCreated()
        {
            ...
            //Act
            var response = await _client.PostAsJsonAsync("api/EnderecoAnimal", novoEnderecoAnimal);
        ...
        public async Task UpdateEnderecoAnimal_DadosValidos_RetornaSucesso()
        {
            ...
            //Act
            var response = await _client.PostAsJsonAsync("api/EnderecoAnimal/atualizar/{id_EnderecoAnimal}", EnderecoAnimalAtualizado);
